...
if(isset($_POST['username-u']) && isset($_POST['password-u'])){
    ...
    if($username != '' && $password != ''){
        $querycheckadmin = "SELECT aa_user_id,aa_user_id_encode,aa_menu,aa_name FROM account_admin WHERE aa_username='$username' AND aa_password='".md5($password)."'";
        ...
        if($rowcheckadmin == 1){
           // echo "<script>alert('post3');</script>";
            ...
            header("Location: index.php?pt=linebot"); // Redirect user to index.php
        }else{
...
<head>
    ...
    <link rel="apple-touch-icon" href="tempate/app-assets/images/ico/apple-icon-120.png">
                            ...
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <form class="auth-login-form mt-2" action="index.html" method="POST">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="login-email" type="text" name="username-u" placeholder="john@example.com" aria-describedby="login-email" autofocus="" tabindex="1" />
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input class="form-control form-control-merge" id="login-password" type="password" name="password-u" placeholder="············" aria-describedby="login-password" tabindex="2" />
